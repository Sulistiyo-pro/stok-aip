...
class Laporan_stok extends CI_Controller {
    ...
    function posisi_stok1() {
        ...
        $this->load->view('template', [
            'content' => $this->load->view('laporan_stok_harian', ['data' => $data], true)
        ]);
    }
    ...
    function ubah_tanggal() {
        ...
        redirect('laporan_stok/' . $this->input->post('Laporan_stok') . '/' . $this->input->post('tanggal'));
    }
    ...
    function hitung_ulang() {
        ...
        $this->db->query($sql);
        redirect('laporan_stok/posisi_stok1');
    }
