<div class="row">
    <div class="col-md-6">
        <h4><strong>Laporan Stok Global</strong></h4>
    </div>
    <div class="col-md-6">
        <form class="form form-inline pull-right" method="get" action="<?= site_url() ?>/laporan_stok/posisi_stok1">
            <label>Tanggal</label>
...
<!--<?= anchor('laporan_stok/hitung_ulang','HITUNG ULANG STOK (SESUAI TANGGAL PC)','class="btn btn-danger"') ?>
<br /><br />-->
