<h4><strong>Stok Awal Hari Ini</strong></h4>
<hr style="margin-top: 0px; margin-bottom: 10px;"/>
<form method="post" action="<?= site_url() ?>/stok_awal/<?= isset($data['id']) ? 'update' : 'create' ?>">
    ...
    <a href="<?= site_url() ?>/stok_awal" type="button" class="btn btn-danger">Batal</a>
</form>